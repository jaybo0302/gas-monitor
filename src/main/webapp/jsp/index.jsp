...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li>${USER_CONTEXT.realName}</li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">${USER_CONTEXT.userName}<i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="${pageContext.request.contextPath}/common/logout.do" >退出</a></li>
				</ul>
			</li>
					...
					<ul>
						<c:forEach var="r1" begin="1" end="${rs.size()}" items="${rs}" step = "1">
							<c:if test="${r1.pId == r.id}">
								<li><a data-href="${pageContext.request.contextPath}/${r1.url}" data-title="${ r1.name}" href="javascript:void(0)">${r1.name }</a></li>
							</c:if>
						</c:forEach>
					</ul>
				</dd>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="jsp/blank.jsp">首页</span>
					<em></em>
				</li>
			</ul>
		</div>
